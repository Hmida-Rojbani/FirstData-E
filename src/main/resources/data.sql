...
insert into game_entity (id, title, type) values (1, 'Fifa2020', 'football');
insert into played_by (games_id, persons_id) values (1, 1);
insert into game_entity (id, title, type) values (2, 'POP', 'advanture');
...
insert into game_entity (id, title, type) values (3, 'GOD', 'advanture');
